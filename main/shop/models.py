...
class Category(models.Model):
  ...
  image = models.ImageField(upload_to="category-image/", blank=True, null=True, verbose_name="Изображение категории")
...
class Models(models.Model):
  ...
  now_head = models.CharField(max_length=150, blank=True, null=True, db_index=True, verbose_name="Номинальный напор(м)")
