...
class Models(models.Model):
  ...
  power = models.CharField(max_length=150, db_index=True, verbose_name="Мощность")
  el_network = models.CharField(max_length=150,  db_index=True, verbose_name="Электрическая сеть")
  nom_capacity = models.CharField(max_length=150,  db_index=True, verbose_name="Ном. Производительность(м3/час)")
  max_capacity = models.CharField(max_length=150,   db_index=True, verbose_name="Макс. Производительность(м3/час)")
  max_capacity_min = models.CharField(max_length=150,   db_index=True, verbose_name="Макс. производительность (л/мин)")
  now_head = models.CharField(max_length=150,  db_index=True, verbose_name="Номинальный напор(м)")
  max_head = models.CharField(max_length=150,  db_index=True, verbose_name="Максимальный напор (м)")
  suction_depth = models.CharField(max_length=150,  db_index=True, verbose_name="Максимальная глуб. всасывания(м)")
  con_size = models.CharField(max_length=150,  db_index=True, verbose_name="Присоединительный размер (дюйм)")
  order_by = models.CharField(max_length=150,   db_index=True, default="0", verbose_name="Порядок сортировки")
  status = models.CharField(
      max_length=20,
      choices=STATUS_CHOICES,
      default='draft',
